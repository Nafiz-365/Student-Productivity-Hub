    ...
    useEffect(() => {
        const generateAIInsights = async () => {
            ...
            const completedAssignments = assignments.filter(
                (a) => a.status === 'completed' && a.grade !== undefined,
            );
            const averageGrade =
            ...
            const consistencyScore =
                (studyDays.filter((day) => last7Days.includes(day)).length /
                    7) *
                100;
            ...
            if (upcomingDeadlines.length >= 2) {
                const daysUntilFirst = Math.ceil(
                    (new Date(upcomingDeadlines[0].dueDate).getTime() -
                        today.getTime()) /
                        (1000 * 60 * 60 * 24),
                );
            ...
            const avgWeeklyCompletion =
                last4Weeks.reduce((sum, week) => sum + week, 0) /
                last4Weeks.length;
            ...
            const avgDailyStudy =
                totalStudyTime / Math.max(studyDays.length, 7);
                ...
                <div className="card p-8 max-w-md">
                    <div className="text-center">
                        ...
                        <p className="text-gray-600 dark:text-gray-300 mb-4">
                            Analyzing your productivity patterns, study habits,
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                ...
                <div className="card p-6 text-center">
                    ...
                    <div className="text-3xl font-bold text-gray-900 dark:text-white">
                        {
                            insights.filter((i) => i.type === 'achievement')
                                .length
                        }
                    </div>
                    <p className="text-sm text-gray-600 dark:text-gray-300">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-300">
                                Deep learning model analyzing your patterns in
                                real-time
                            </p>
                        </div>
                    </div>
            ...
            <div className="text-center mt-8">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                    Insights are personalized based on your unique patterns and
                    behaviors
                </p>
            </div>
        </div>
