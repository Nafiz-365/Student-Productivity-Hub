...
const AchievementSystem: React.FC = () => {
    ...
    const previousAchievementsRef = React.useRef<string[]>([]);
    ...
    useEffect(() => {
        const checkAchievements = () => {
            ...
            const newUnlocked = newAchievements.filter(
                (a) =>
                    a.unlocked &&
                    !previousAchievementsRef.current.includes(a.id),
            );
            ...
            previousAchievementsRef.current = newAchievements.map((a) => a.id);
                    ...
                    <div className="card p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {unlockedAchievements.map((achievement) => (
                                ...
                                >
                                    <div
                                        className={`p-2 rounded-lg ${achievement.color} text-white`}
                                    >
                                        {achievement.icon}
                                    </div>
