...
const AdminDashboard: React.FC = () => {
    ...
    const isAdmin =
        user?.email?.endsWith('@admin.studyhub.com') ||
        user?.email === 'admin@studyhub.demo';
            ...
            <Security>
                <div className="mt-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div className="card p-6 glass-panel">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex justify-between items-center p-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                                    ...
                                    <span className="px-3 py-1 bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-300 rounded-full text-xs font-bold uppercase">
                                        Production
                                    </span>
                                </div>
                        ...
                        <div className="card p-6 glass-panel">
                            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-2">
                                <Zap className="w-5 h-5 text-amber-500" /> User
                                Impact
                            </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="card p-6 glass-panel">
                    <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                        <Settings className="w-5 h-5 text-gray-500" /> Feature
                        Flags
                    </h3>
                ...
                <div className="card p-6 glass-panel">
                    <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                        <Lock className="w-5 h-5 text-gray-500" /> Secured
                        Actions
                    </h3>
