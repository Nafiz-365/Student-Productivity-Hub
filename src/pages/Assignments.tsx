        ...
        <div className="space-y-8 animate-in fade-in zoom-in duration-500">
                ...
                <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div>
                        ...
                        <p className="text-emerald-100 text-lg">
                            Manage your coursework. You have{' '}
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                {[
                    ...
                    <div
                        key={idx}
                        className="card p-4 flex flex-col justify-between glass-panel hover:-translate-y-1 transition-transform duration-300"
                    >
                        <div
                            className={`p-2 w-fit rounded-lg bg-${stat.color}-100 dark:bg-${stat.color}-900/30 text-${stat.color}-600 dark:text-${stat.color}-400 mb-3`}
                        >
            ...
            <div className="space-y-4">
                {filteredAssignments.length === 0 ? (
                    ...
                    filteredAssignments.map((assignment) => {
                        ...
                        const isOverdue =
                            daysLeft < 0 && assignment.status !== 'completed';

                        return (
                            <div
                                key={assignment.id}
                                className={`group card p-5 flex flex-col md:flex-row items-start gap-5 transition-all duration-300 hover:shadow-lg hover:scale-[1.01] border-l-4 ${
                                    ...
                                    <div className="flex items-start justify-between">
                                        <div>
                                            <div className="flex items-center gap-3 mb-1">
                                                ...
                                                <span
                                                    className={`text-xs px-2 py-0.5 rounded-full border ${getStatusColor(assignment.status)}`}
                                                >
                                            ...
                                            <h3
                                                className={`text-lg font-bold text-gray-900 dark:text-white mb-1 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors ${
                                                    assignment.status ===
                                                    'completed'
