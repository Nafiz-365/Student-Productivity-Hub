                ...
                <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div>
                        ...
                        <p className="text-violet-100 text-lg">
                            Stay organized and focused. You have{' '}
                    ...
                    {filteredTasks.length === 0 ? (
                        ...
                        <div className="space-y-4">
                            {filteredTasks.map((task) => (
                                <div
                                    key={task.id}
                                    className={`group relative card p-5 transition-all duration-300 hover:scale-[1.01] hover:shadow-lg border-l-4 ${
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-start justify-between">
                                                <div>
                                                    <h3
                                                        className={`text-lg font-semibold text-gray-900 dark:text-white transition-all ${
                                                            task.status ===
                                                            'completed'
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <span
                                                        className={`px-2.5 py-1 rounded-lg text-xs font-bold uppercase tracking-wider border ${getPriorityColor(task.priority)}`}
                                                    >
                                                        {task.priority}
                                                    </span>
                    ...
                    <div className="card w-full max-w-lg shadow-2xl">
                        ...
                        >
                            ...
                            <p className="text-xs text-gray-500 italic">
                                * Quick add mode. Details can be edited after
                                creation.
                            </p>
